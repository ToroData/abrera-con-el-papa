window.CONFIG = {
  ...
  fallback: {
    ...
    reels: [
      {
        url_video: 'https://dxup7x5ioy4or.cloudfront.net/VID-20260426-WA0014.mp4',
        titol_ca: 'Què esperem de la visita del papa?',
        titol_es: '¿Qué esperamos de la visita del papa?',
        desc_ca: 'Part de la comunitat de Sant Pere d\'Abrera i fidel a l\'adoració eucarística dels dijous',
        desc_es: 'Parte de la comunidad de Sant Pere de Abrera y fiel a la adoración eucarística de los jueves',
        autor: 'Marylin',
        data: '2026-04-26',
      },
      {
        url_video: 'https://dxup7x5ioy4or.cloudfront.net/VID-20260426-WA0015.mp4',
        titol_ca: 'Què esperem de la visita del papa?',
        titol_es: '¿Qué esperamos de la visita del papa?',
        desc_ca: 'Part de la comunitat de Sant Pere d\'Abrera',
        desc_es: 'Parte de la comunidad de Sant Pere de Abrera',
        autor: 'David y Jéssica',
        data: '2026-04-26',
      },
      {
        url_video: 'https://dxup7x5ioy4or.cloudfront.net/VID-20260426-WA0016.mp4',
        titol_ca: 'Què esperem de la visita del papa?',
        titol_es: '¿Qué esperamos de la visita del papa?',
        desc_ca: 'Part de la comunitat de Sant Pere d\'Abrera',
        desc_es: 'Parte de la comunidad de Sant Pere deAbrera',
        autor: 'Lola',
        data: '2026-04-26',
      },
      {
        url_video: 'https://dxup7x5ioy4or.cloudfront.net/VID-20260426-WA0017.mp4',
        titol_ca: 'Què esperem de la visita del papa?',
        titol_es: '¿Qué esperamos de la visita del papa?',
        desc_ca: 'Catequista de la parròquia de Sant Pere d\'Abrera',
        desc_es: 'Catequista de la parroquia de Sant Pere de Abrera',
        autor: 'María',
        data: '2026-04-26',
      },
      {
        url_video: 'https://dxup7x5ioy4or.cloudfront.net/VID-20260426-WA0018.mp4',
        titol_ca: 'Què esperem de la visita del papa?',
        titol_es: '¿Qué esperamos de la visita del papa?',
        desc_ca: 'Catequista de la parròquia de Sant Pere d\'Abrera',
        desc_es: 'Catequista de la parroquia de Sant Pere de Abrera',
      ...
      {
        url_video: 'https://dxup7x5ioy4or.cloudfront.net/VID-20260426-WA0019.mp4',
        titol_ca: 'Què esperem de la visita del papa?',
        titol_es: '¿Qué esperamos de la visita del papa?',
        desc_ca: 'Membre del grup de joves de la parròquia de Sant Pere d\'Abrera',
        desc_es: 'Miembro del grupo de jóvenes de la parroquia de Sant Pere de Abrera',
        autor: 'Ana',
        data: '2026-04-26',
      },
    ],
